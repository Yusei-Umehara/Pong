...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text paddle2ScoreText;  // before private

    [SerializeField] private Transform paddle1Transform;
    [SerializeField] private Transform paddle2Transform;
    [SerializeField] private Transform ballTransform;

    public static int paddle1Score;
    public static int paddle2Score;
